...
# Code artifact upload limits
CODE_ARTIFACT_MAX_FILE_SIZE_BYTES = 200 * 1024
CODE_ARTIFACT_MAX_FILES_PER_CONVERSATION = 10
CODE_ARTIFACT_CONTEXT_MAX_LINES = 400
CODE_ARTIFACT_CONTEXT_MAX_CHARS = 12000
CODE_EXECUTION_LOOP_ENABLED = _env_bool("CODE_EXECUTION_LOOP_ENABLED", True)
CODE_EXECUTION_PATCH_TIMEOUT_SECONDS = max(5.0, _env_float("CODE_EXECUTION_PATCH_TIMEOUT_SECONDS", 25.0))
CODE_EXECUTION_COMMAND_TIMEOUT_SECONDS = max(5.0, _env_float("CODE_EXECUTION_COMMAND_TIMEOUT_SECONDS", 20.0))
CODE_EXECUTION_MAX_PATCH_CHARS = max(1000, _env_int("CODE_EXECUTION_MAX_PATCH_CHARS", 12000))
CODE_EXECUTION_MAX_OUTPUT_CHARS = max(500, _env_int("CODE_EXECUTION_MAX_OUTPUT_CHARS", 1200))
